...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-20", className)}>
            <div style={{left:'30vw',top:"30vh",height:"20px",marginTop:'80px',fontWeight:"700"}}>
                <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300" style={{ fontSize: '40px', color: "white", textAlign: "center" }}>
                    {title || `Sell and Buy property with InDeState`}
                </p>
                <p className="text-xl md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto" style={{ fontSize: '30px', color: "white", textAlign: "center",marginTop:'20px' }}>
                    {description ||
                        `Transformaing the way real estate is traded in the market`}
                </p>
            </div>
